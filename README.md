...
2. Creá un **banco** o agregá uno de los **bancos listos para usar** (Construcción de Ciudadanía, Política y Ciudadanía, Trabajo y Ciudadanía, Derecho, cuatro escapes listos y un ejemplo de Biología). Podés pegar filas desde una planilla de Google o Excel.
